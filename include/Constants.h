...
constexpr char CONFIGURATION_UUID[] = "76b50002-a1b2-c3d4-e5f6-1234567890ab";
constexpr char START_UUID[] = "76b50003-a1b2-c3d4-e5f6-1234567890ab";
constexpr char STOP_UUID[] = "76b50004-a1b2-c3d4-e5f6-1234567890ab";
...
constexpr uint16_t MIN_ADVERTISEMENT_INTERVAL_MS = 100;
constexpr uint16_t MAX_ADVERTISEMENT_INTERVAL_MS = 5000;
